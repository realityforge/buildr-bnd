...
=== Remove certain headers from generated manifest

By default we should be removing headers that are not relevant in the OSGi world or only there for
the build process. i.e. We could consider defaulting the headers removed to;
